...
public struct Vector {
  ...
  public var magnitude: Numeric = 1

  public var dx: Numeric {
    return cos(angle) * magnitude
  }

  public var dy: Numeric {
  ...
  public static func invert(vector: Vector) -> Vector {
    return Vector(angle: vector.angle + M_PI.radians)
  }
  ...
  ///
  public static func rotate(vector: Vector, by theta: Angle) -> Vector {
    return Vector(angle: vector.angle + theta, magnitude: vector.magnitude)
  }

  public func rotate(by theta: Angle) -> Vector {
...
extension Vector: Hashable {
  public var hashValue: Int {
    return angle.radians.hashValue &+ dx.value().hashValue &+ dy.value().hashValue
  }
}
